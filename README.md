...
Each `.py` file contains my solution to a CodeForces problem. The file name includes the problem code before the `.py` extension.
For example:
- `2188A.py` - Solution to CodeForces problem **2188A**

Files are organized into folders corresponding to contest rounds. Each folder is named `Rxxxx`, where `xxxx` is the round number.
For example:
- `R1077/` - Contains all problems solved during **CodeForces Round 1077**

All questions are completed **without** the help of guides or AI
